local CiderRunMode = {};CiderRunMode.sdk = "Corona";CiderRunMode.assertImage = true;CiderRunMode.userdir = "C:/Documents and Settings/KYEL/Application Data/.luaglider/dev";local CORONA_SOCKET_PORT=51248;local SOCKET_PORT=51249;local GLIDER_MAIN_FOLDER= "C:/Documents and Settings/KYEL/Mina dokument/Dropbox/kickboard/clean";local useNativePrint= false;
--v1.70
-----------------------------------------------------------------------------------------
--
-- main.lua
